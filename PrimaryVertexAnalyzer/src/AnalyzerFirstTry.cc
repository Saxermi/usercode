/*
First goal: make a historgram that analyzes the effiency of the matching between simulated
and reconstructed vertices
*/

#include "cms_vertex_reco/interface/FirstTryAnalyzer.h"
#include "cms_vertex_reco/interface/FFA.h"
